...
namespace SwcBuild
{
    ...
    internal static class Utilities
	{
		public static bool AreFilesEqual(string file1, string file2)
		{
			...
			var stream1 = new FileStream(file1, Open, Read);
			var stream2 = new FileStream(file2, Open, Read);

			try
			{
				if (!stream1.Length.Equals(stream2.Length))
					return false;
				...
				do
				{
					...
					if (!byte1.Equals(stream2.ReadByte()))
						return false;
				}
